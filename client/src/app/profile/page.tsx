          ...
          <div className="rounded-lg border bg-dark-3 px-4 pt-8 pb-10 shadow-lg">
            <div className="relative mx-auto w-36 rounded-full">
              ...
              <Image
                ...
                src="/placeholder-profile.jpg" // Add your image path here
                alt="Profile"
                width={144}
                height={144}
              />
            ...
            <p className="text-center text-xs mt-4 leading-6 text-white hover:text-gray-600">
              Hey I&apos;m Mouli, a full stack blockchain developer. I specialize in building decentralized applications using Ethereum and Solidity.
            </p>
            <ul className="mt-3 divide-y rounded py-2 px-3 text-white shadow-sm hover:text-gray-700 hover:shadow">
              ...
              <li className="flex items-center py-3 text-sm">
                <span>Joined On</span>
                <span className="ml-auto">Apr 21, 2024</span>
              </li>
            </ul>
          </div>
        </div>
